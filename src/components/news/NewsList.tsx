...
const mockNews = [
  {
    ...
    paragraphs: [
      ...
      '"I am very pleased to congratulate and welcome Jim to CompQsoft Digital\'s Board of Directors," said Madhu Sheikh, CEO of CompQsoft Digital. "Jim is a highly accomplished executive with extensive experience scaling Microsoft-focused businesses. I am confident his leadership and strategic foresight will bring significant value to our board and our continued growth."',
      '"Jim brings a wealth of leadership experience and an impressive record of execution at the forefront of Microsoft Dynamics 365 solutions," added Craig Moser, President and Board Member of CompQsoft Digital. "His ability to envision the future and deliver results aligns perfectly with our customer-centric innovation goals."',
      ...
      'We empower businesses to build agile, customer-centric solutions by harnessing the power of Microsoft technologies. Our service offerings span Cloud Modernization, Data & Analytics, Business Applications (CRM/ERP), Automation, and next-gen innovations like Generative AI and Copilots. As an ISO-certified and CMMI Level 3 organization, CompQsoft Digital is committed to delivering excellence, accelerating growth, and transforming your digital future.'
    ],
    imageSrc: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=400' // Placeholder for Jim Sheehan
  },
  {
    id: 2,
    indexNumber: '02',
