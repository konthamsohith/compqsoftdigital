...
import styles from './IndustriesContact.module.css';

export default function IndustriesContact() {
    ...
    <section id="contact" className={styles.section}>
      <div className={styles.container}>
        <h2 className={styles.heading}>
          Let&rsquo;s shape the future of your industry&mdash;together. Contact us to learn more.
        </h2>
        ...
        {submitted ? (
          <p className={styles.thankYou}>Thanks for reaching out! We&rsquo;ll be in touch soon.</p>
        ) : (
          <form className={styles.form} onSubmit={handleSubmit}>
            <div className={styles.fieldsColumn}>
              <div className={styles.fieldGroup}>
                <label htmlFor="firstName" className={styles.label}>First Name</label>
                <input id="firstName" name="firstName" type="text" className={styles.input} />
              </div>

              <div className={styles.fieldGroup}>
                <label htmlFor="lastName" className={styles.label}>Last Name</label>
                <input id="lastName" name="lastName" type="text" className={styles.input} />
              </div>
